...
async def test_stdp_core(dut):
    ...
    # Pre-synaptic spike fires BEFORE Post-synaptic spike
    # Expected result: Weight INCREASES (+16)
    # ----------------------------------------------------
    ...
    # Wait 5 clock cycles (simulating a biological delay within the window)
    ...
    await ClockCycles(dut.clk, 2) # Wait for logic to settle
    ...
    # Post-synaptic spike fires BEFORE Pre-synaptic spike
    # Expected result: Weight DECREASES (-8)
    # ----------------------------------------------------
